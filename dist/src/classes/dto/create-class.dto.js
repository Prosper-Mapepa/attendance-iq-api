...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 9.144, description: 'Location radius in meters (default: 9.144m = 30ft). Accepts 1.5-30.5 meters (5-100 feet) for precise verification' }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.Min)(1.5),
    (0, class_validator_1.Max)(30.5),
    __metadata("design:type", Number)
