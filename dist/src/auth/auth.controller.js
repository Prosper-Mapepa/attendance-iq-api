...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Generate QR code' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'QR code generated' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create production admin user (one-time use)' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Admin user created successfully' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid secret or admin already exists' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
